...
class Command(BaseCommand):
    help = 'Deletes reels older than 15 days, programs older than 10 days and productions older than 15 days.'
    ...
    def handle(self, *args, **kwargs):
        ...
        productions_cutoff_date = timezone.now() - timezone.timedelta(days=15)
